...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute z-10 h-full w-64 origin-left rounded-b-xl rounded-r-xl border border-[#D9D9D9] bg-light transition-transform dark:border-gray-700 dark:bg-dark ${isSidebarOpen ? 'scale-x-100' : 'scale-x-0'
      ...
      >
        ...
        <div className="flex flex-col gap-2 p-6">
          <NavLink
            to={'/admin/users'}
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-xl bg-light px-3 py-[10px] text-sm font-medium text-light-title dark:bg-dark dark:text-dark-title ${isActive && '!dark:text-dark-title !bg-black !text-dark-title dark:!bg-dark-card '
              }`
            }
          >
            <UserIcon /> Users
