...
// Create a new post
router.post('/', authMiddleware, upload.array('images'), createPostHandler);
...
// Update a post by ID
router.patch('/:id', authMiddleware, isAuthorMiddleware, upload.array('images'), updatePostHandler);

// Delete a post by ID
router.delete('/:id', authMiddleware, isAuthorMiddleware, deletePostByIdHandler);

// Update a post by admin with ID
router.patch('/admin/:id', authMiddleware, isAdminMiddleware, upload.array('images'), updatePostHandler);
